...
AI Engineer · Agentic Systems · RAG & LLM Engineering 🎓 Master of Computer Science (AI & Data Science) — University of Sydney 📍 Sydney, NSW · 🔗 LinkedIn 💼 Open to AI Engineer, RAG Engineer, LLM Engineer and Agentic AI roles in Sydney · Full working rights in Australia
...
Solo Project · AWS Bedrock AgentCore · Claude Agent SDK 🔗 Live Dashboard · GitHub
...
Solo Project · Hybrid Retrieval · Two-Layer Evaluation Harness 🔗 Live Dashboard · GitHub
...
Arc Intelligence Lab · USyd Capstone · 8-person team, individually built full-stack components 🔗 mmd-intelligence-explorer · cord19-semantic-search
